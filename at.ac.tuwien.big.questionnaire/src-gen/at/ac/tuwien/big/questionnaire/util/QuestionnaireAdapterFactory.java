...
public class QuestionnaireAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected QuestionnaireSwitch<Adapter> modelSwitch =
    new QuestionnaireSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseSimpleAnswer(SimpleAnswer object)
      {
        return createSimpleAnswerAdapter();
      }
      @Override
      public Adapter caseInputAnswer(InputAnswer object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.questionnaire.SimpleAnswer <em>Simple Answer</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link at.ac.tuwien.big.questionnaire.InputAnswer <em>Input Answer</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
