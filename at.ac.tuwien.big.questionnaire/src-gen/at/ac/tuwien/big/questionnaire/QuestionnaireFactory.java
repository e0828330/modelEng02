...
public interface QuestionnaireFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Simple Answer</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Simple Answer</em>'.
   * @generated
   */
  SimpleAnswer createSimpleAnswer();

  /**
   * Returns a new object of class '<em>Input Answer</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Input Answer</em>'.
   * @generated
   */
